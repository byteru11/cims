<%--~
  ~ @Copyright:2020
  ~ @Author:Zero
  ~ @LastModified:2020-05-04 15:24:07
  --%>
...
<html>
    ...
    <body>
        <div class="weadmin-body">
            <form class="layui-form" action="../../invoice/addInvoice.do" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_username" value="第一分公司" placeholder="来源" name="from" lay-verify="required|nikename" autocomplete="off" class="layui-input">
                    </div>
                </div>
