...
<html>
    ...
    <body>
        <div class="weadmin-body">
            <div class="weadmin-body">
                <form class="layui-form" action="../../invoice/updateInvoice.do" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username1" value="${param.d}" placeholder="去处" name="from" lay-verify="required|nikename" autocomplete="off" class="layui-input">
                        </div>
